...
def build_openbookqa_prompt(question: str, choices: list[str], letters: list[str]) -> str:
    choices_str = "\n".join([f"{v}. {k}" for k, v in zip(choices, letters)])
...
if __name__ == "__main__":
    model_id = "/home/sora/llm/moe/ckpt/DeepSeek-V2-Lite-Pruned"

    dataset_examples = load_openbookqa()

    correct_count, total_count, detailed_results = evaluate_openbookqa(model_id, dataset_examples)

    output_filename = "/home/sora/llm/moe/output/deepseek_pre_pruned/raw_result_openbookqa.json"
