...
def evaluate(model_id: str,
    ...
    outputs = llm.generate(prompts=prompts, sampling_params=sampling_params, lora_request=lora_request)
    for out in outputs:
...
if __name__ == "__main__":
    ...
    output_file = "/home/sora/llm/moe/output/deepseek_presft_qkv/result.jsonl"
    adapter_path = "/home/sora/llm/moe/ckpt/deepseek_presft_qkv/checkpoint-776"
    evaluate(model_id, input_file, output_file,
             batch_size=8, max_tokens=512, adapter_path=adapter_path)
